...
import { initNotifications } from "../../services/notificationsService";
    ...
    <ThemedView safe style={[themeStyles.container, { paddingBottom: 40 }]}>
      ...
      >
            ...
            {jobs.slice(0, 3).map((item) => (
              <View key={item.id} style={themeStyles.bannerCard}>
                ...
                <View style={themeStyles.bannerOverlay}>
                  ...
                  >
                    <ThemedText style={themeStyles.bannerButtonText}>
                      Book Now
                    </ThemedText>
                  </ThemedButton>
                </View>
        ...
        <View style={themeStyles.sectionHeader}>
          <ThemedText title style={themeStyles.sectionTitle}>
            Categories
          </ThemedText>
          <TouchableOpacity onPress={() => safeRouter.push("/browse")}>
            <ThemedText title style={themeStyles.link}>
              View More
            </ThemedText>
          </TouchableOpacity>
        </View>
        ...
        >
          {categories.slice(0, 5).map((cat) => (
            <View key={cat.id} style={themeStyles.categoryCard}>
              ...
              />
              <ThemedText style={themeStyles.categoryLabel}>
                {cat.label}
              </ThemedText>
            </View>
          ))}
        ...
        <ThemedText
          title
          style={[themeStyles.sectionTitle, { paddingHorizontal: 15 }]}
        >
          Top Jobs
        </ThemedText>
