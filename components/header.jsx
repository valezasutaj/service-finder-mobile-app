    ...
    return (
        ...
        <View style={[styles.headerContainer, { backgroundColor: theme.uiBackground }]}>
            ...
            <View style={styles.rightSection}>
                ...
                <TouchableOpacity style={[styles.iconButton, { backgroundColor: theme.primary }]} onPress={() => safeRouter.push('/booking')}>
...
const s = (theme) => StyleSheet.create({
    headerContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: theme.border, borderRadius: 16 },
